...
public class AppointmentModel {
	...
	public long add(AppointmentBean bean) throws ApplicationException, DuplicateRecordException {
		...
		try {
			...
			PreparedStatement pstmt = conn.prepareStatement("INSERT INTO H_Appointment VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?)");
			pstmt.setInt(1, pk);
	 ...
	 public void delete(AppointmentBean bean) throws ApplicationException {
	        ...
	        try {
	            ...
	            PreparedStatement pstmt = conn
	                    .prepareStatement("DELETE FROM H_AppointMent WHERE ID=?");
	 ...
	 public List search(AppointmentBean bean) throws ApplicationException {
	     ...
	     *  @throws ApplicationException
	     */
	    public List search(AppointmentBean bean, int pageNo, int pageSize)
	            throws ApplicationException {
	    ...
	    public void update(AppointmentBean bean) throws ApplicationException,
    ...
    try {
        ...
        conn.setAutoCommit(false); // Begin transaction
        PreparedStatement pstmt = conn
                .prepareStatement("UPDATE H_Appointment SET FirstNAME=?,LastName=?,DoctorName=?,Deceased=?,time=?,AppDate=?,MobileNo=?,Address=?,CREATEDBY=?,MODIFIEDBY=?,CREATEDDATETIME=?,MODIFIEDDATETIME=? WHERE ID=?");
